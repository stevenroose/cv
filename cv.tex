...
\item[]
	...
	\begin{itemize}
		...
		\resdateitem{Faculty Standing Education Commission}{Sep. 2015 - present} % name unsure
		\resdateitem{Student Services Council KU Leuven}{Sep. 2015 - present}
		\resdateitem{Student Services Council KU Leuven, Campus Leuven}{Sep. 2015 - present}
		\resdateitem{General Assembly of Student Council KU Leuven (Stura KU Leuven)}{Sep. 2015 - present}
		\resdateitem{General Assembly of Flemish Student Association (VVS)}{Sep. 2015 - present}
	\end{itemize}
...
%
%\begin{description}
%\item[Hobbies:] scouting, reading, occasional gaming, playing guitar
%\item[Technology-related interests:] Android, Bitcoin, web technology
%\item[Interests:] environmental issues, physics, philosophy, nature
%\item[Characteristics:] trustworthy, thoughtful, perspicacious, passionate
%\end{description}
